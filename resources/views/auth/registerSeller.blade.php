        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="section-title text-center">
                    ...
                    <h2 class="text-white">Create An Seller Account!</h2>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                <label for="name" class="col-md-3 control-label text-success">Nama Toko</label>
                        ...
                        <small>
                            <span class="text-light fw-light">Sudah Punya Akun Seller?</span> <a class="text-light fw-bold" href="/loginSeller">Login</a>
                        </small>
                    </div>
