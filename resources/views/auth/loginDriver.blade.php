            ...
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <div class="section-title text-center">
                        ...
                        <h2 class="text-white">Login Driver Account!</h2>
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="POST" action="{{ route('login') }}">
                                ...
                                <small>
                                    <span class="text-light fw-light">Belum Punya Akun Driver?</span> <a class="text-light fw-bold" href="/registerDriver">Register Now</a>
                                </small>
                            </form>
                        </div>
                    </div>
