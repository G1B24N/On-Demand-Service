...
<body>
    <div id="app">
                            ...
                            <div class="menu-btn">
                                <ul class="navbar-nav m-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        @if (empty($restoran->nama_restoran))
        ...
        <div class="modal fade" id="exampleModal" tabindex="-999999" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="footer-side-list">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <a href="/cdn-cgi/l/email-protection#adc8c0ccc4c1edddc4d5c4de83cec2c0"><span
                                                style="text-transform: none"
                                                {{-- class="__cf_email__"
                                                    data-cfemail="f1949c90989db18198899882df929e9c" --}}>cs@doapps.com</span></a>
                                    </li>
                                    {{-- <li>
                                            <i class='bx bxl-telegram'></i>
                                    ...
                                    <li>
                                        <i class='bx bxs-map'></i>
                                        <a target="_blank"
                                            href="https://www.google.com/maps/place/Gamelab+Indonesia/@-7.3223703,110.5036376,17z/data=!3m1!4b1!4m5!3m4!1s0x2e7a791eea650a7b:0xa48e44ca27450c1b!8m2!3d-7.3223756!4d110.5058263">Jawa
                                            Tengah, Indonesia</a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-8 col-md-9">
                            <div class="bottom-text">
                                ...
                                <ul class="social-bottom">
                                    ...
                                    <li>
                                        <a href="https://www.instagram.com/?hl=id" target="_blank"><i
    ...
    <script
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD1eGdP6hCYQ06z86dMEwoLNFMPYPbhgYs&amp;libraries=places&amp;callback=initMap">
    </script>
