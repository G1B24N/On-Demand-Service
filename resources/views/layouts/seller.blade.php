...
<body class="hold-transition sidebar-mini sidebar-collapse">
    ...
    <aside id="sidebar" class="main-sidebar sidebar-light elevation-4 position-fixed" style="background:  #00695c">
        <!-- Brand Logo -->
        <a href="#" class="brand-link">
            <img src="{{ asset('img/logo.png') }}" alt="AdminLTE Logo" style="opacity: .8; margin-left: 10px;">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <li class="nav-item">
                <a href="/dashboard_seller" class="nav-link">
            ...
            <li class="nav-item mt-2">
                ...
                <a href="/product/indexSeller" class="nav-link">
                ...
                <a href="/restaurant/index" class="nav-link">
                    <i class="nav-icon fa fa-book text-light"></i>
                    <p class="text-light">
                        Restoran
                        <i class="right"></i>
                ...
                <a href="/incomingOrder/index" class="nav-link">
                    <i class="nav-icon fa fa-book text-light"></i>
                    <p class="text-light">
                        Pesanan
                        <i class="right"></i>
