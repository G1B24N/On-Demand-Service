<div class="modal fade" id="editOrder{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  ...
	  <div class="modal-content">
		...
		<div class="modal-body">
		  <div class="card-body">
			  ...
			  <form action="{{ route('editOrder', ['id'=>$p->id])}}" method="POST" enctype="multipart/form-data">
				  ...
				  <div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							value="{{ $p->restaurant->nama_restoran }}"  
							>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							value="{{ $p->metode_pembayaran }}"  
							>
						</div>
					</div>
					  <div class="row">
						  <div class="text-center">
							  <a href="{{route('indexOrder')}}" class="btn btn-outline-success mr-2" role="button"><i class="fa fa-ban"></i></a>
