<div class="modal fade" id="editPayment{{$p->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	  ...
	  <div class="modal-content">
		...
		<div class="modal-body">
		  <div class="card-body">
			  ...
			  <form action="{{ route('editPayment', ['id'=>$p->id])}}" method="POST" enctype="multipart/form-data">
					...
					<div class="col-md-6">
					  ...
					  <div class="row">
						  <div class="text-center">
							  <a href="{{route('indexPayment')}}" class="btn btn-outline-success mr-2" role="button"><i class="fa fa-ban"></i></a>
